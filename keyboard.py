...
encoder_handler.map = [((KC.AUDIO_VOL_DOWN, KC.AUDIO_VOL_UP),), ((KC.BRIGHTNESS_UP, KC.BRIGHTNESS_DOWN))]
...
# LEDs
rgb = RGB(pixel_pin=board.GP17, num_pixels=106, val_limit=25, val_step=5, val_default=10)
...
keyboard.keymap = [
    [KC.ESCAPE, KC.F1, KC.F2, KC.F3, KC.F4, KC.F5, KC.F6, KC.F7, KC.F8, KC.F9, KC.F10, KC.F11, KC.F12, KC.PGUP, KC.PGDOWN, KC.INSERT, KC.KP_SLASH, KC.AUDIO_MUTE,
     ...
     KC.LCTRL, KC.LGUI, KC.LALT, KC.RGB_TOG, KC.SCROLLLOCK, KC.SPACE, KC.LWIN(KC.E), KC.RGB_VAI, KC.RGB_VAD, KC.RALT, KC.APPLICATION, FN, KC.RCTRL, KC.LEFT, KC.DOWN, KC.RIGHT, KC.KP_0, KC.KP_EQUAL
    ],

    # Next layer here (when you press fn button)
    [KC.ESCAPE, KC.MEDIA_PLAY_PAUSE, KC.MEDIA_STOP, KC.MEDIA_PREV_TRACK,  KC.MEDIA_NEXT_TRACK, KC.AUDIO_VOL_UP, KC.AUDIO_VOL_DOWN, KC.AUDIO_MUTE, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
    ...
    KC.LCTRL, KC.LGUI, KC.LALT, XXXXXXX, XXXXXXX, KC.SPACE, XXXXXXX, XXXXXXX, XXXXXXX, KC.RALT, KC.APPLICATION,FN, KC.RCTRL, KC.LEFT, KC.DOWN, KC.RIGHT,XXXXXXX, XXXXXXX],
    ]
